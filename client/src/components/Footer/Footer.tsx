    ...
    <div className="container footer">
      <div className="row">
        <div className="col-md-3 mt-5 col-sm-12">
          <h3 className="title">BharaDei</h3>
          <p className="title ">
            BharaDei, a car rental web which aims to provide you best services
        ...
        <div className="col-md-3 mt-5 col-sm-12">
          ...
          <div className="row">
            <div className="col-md-6 col-sm-6">
              ...
              <p className="title">Order a car</p>
              <p className="title">Buy a car</p>
            </div>
            <div className="col-md-6 col-sm-6">
        ...
        <div className="row d-flex justify-content-between mt-5">
          <div className="text-center title col-md-6">
            Copyright © 2022 BharaDei - All Rights Reserved.
          </div>
